...
from tensorflow.keras.layers import Dense, Dropout, Flatten, Input, Activation, UpSampling2D
...
def tutorial_cnn(num_classes=2, num_features=16, max_lpc_order=50):
